...
export class CreateAccountComponent implements OnInit {
  ...
  onSubmit(){
    this.signupAccount.phone = this.selectedCountry[2] + this.signupAccount.phone;
    ...
    this.userService.signUp(this.signupAccount)
        .subscribe(
            ...
            (err) => {
              // TODO:
              // if error -  view phone number without country code (in form field)
            }
        );
  }
  ...
  phoneChanged(){
    console.log(this.signupAccount.phone);
  }
